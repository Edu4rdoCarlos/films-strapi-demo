"use strict";
(self["webpackChunkfilms_demo"] = self["webpackChunkfilms_demo"] || []).push([[4263],{
...
const EditPage = ({ canUpdate }) => {
  ...
  const handleSubmit = async (body, actions) => {
    ...
    try {
      ...
      if (id.toString() === userInfos.id.toString()) {
        ...
        const userDisplayName = get_default()(body, "username") || (0,getFullName/* getFullName */.P)(body.firstname, body.lastname);
        setUserDisplayName(userDisplayName);
      }
      actions.setValues(pick_default()(body, fieldsToPick));
    } catch (err) {
      const errors = (0,formatAPIErrors/* formatAPIErrors */.I)(err.response.data);
  ...
  const headerLabelName = initialData.username || (0,getFullName/* getFullName */.P)(initialData.firstname, initialData.lastname);
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(67294);
/* harmony import */ var _strapi_design_system__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(59586);
/* harmony import */ var _strapi_design_system__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(40933);
/* harmony import */ var _strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3911);
/* harmony import */ var _strapi_icons__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(2);
