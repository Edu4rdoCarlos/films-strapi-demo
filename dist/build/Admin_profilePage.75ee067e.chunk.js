"use strict";
(self["webpackChunkfilms_demo"] = self["webpackChunkfilms_demo"] || []).push([[9497],{
...
const Preferences = ({ onChange, values, localeNames, allApplicationThemes }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "stretch", gap: 4 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "stretch", gap: 1 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "delta", as: "h2" }, formatMessage({
      ...
      Object.entries(localeNames).map(([language, langName]) => /* @__PURE__ */ react.createElement(SingleSelect/* SingleSelectOption */.ag, { value: language, key: language }, langName))
    )), /* @__PURE__ */ react.createElement(GridItem/* GridItem */.P, { s: 12, col: 6 }, /* @__PURE__ */ react.createElement(
      SingleSelect/* SingleSelect */.q4,
      {
        label: formatMessage({
      ...
      /* @__PURE__ */ react.createElement(SingleSelect/* SingleSelectOption */.ag, { value: "system" }, formatMessage({
        id: "Settings.profile.form.section.experience.mode.option-system-label",
        defaultMessage: "Use system settings"
      })),
      themesToDisplay.map((theme) => /* @__PURE__ */ react.createElement(SingleSelect/* SingleSelectOption */.ag, { value: theme, key: theme }, formatMessage(
        {
  ...
  const submitMutation = (0,es.useMutation)(
    ...
    },
    {
      async onSuccess(data2) {
        ...
        const userDisplayName = data2.username || (0,getFullName/* getFullName */.P)(data2.firstname, data2.lastname);
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": isSubmittingForm }, /* @__PURE__ */ react.createElement(
    ...
    ({ errors, values, handleChange, isSubmitting, dirty }) => {
      return /* @__PURE__ */ react.createElement(dist/* Form */.l0, null, /* @__PURE__ */ react.createElement(
        HeaderLayout/* HeaderLayout */.T,
        {
          title: data.username || (0,getFullName/* getFullName */.P)(data.firstname, data.lastname),
