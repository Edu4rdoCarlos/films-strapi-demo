(self["webpackChunkfilms_demo"] = self["webpackChunkfilms_demo"] || []).push([[9074],{
...
;// CONCATENATED MODULE: ./.cache/admin/src/contexts/apiTokenPermissions.tsx


const ApiTokenPermissionsContext = react.createContext({
  selectedAction: null,
  routes: [],
  selectedActions: [],
  data: {
...
const ApiTokenPermissionsContextProvider = ({
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(ApiTokenPermissionsContext.Provider, { value: rest, children });
};
...
var utils = __webpack_require__(51352);
...
const init = (state, permissions = []) => {
  return {
    ...
    routes: [],
    selectedActions: [],
    data: (0,utils/* transformPermissionsData */.mk)(permissions)
  };
};
...
const reducer = (state, action) => (0,immer_esm/* default */.ZP)(state, (draftState) => {
  switch (action.type) {
    ...
    case "UPDATE_PERMISSIONS_LAYOUT": {
      draftState.data = (0,utils/* transformPermissionsData */.mk)(action.value);
      break;
    }
    case "UPDATE_ROUTES": {
...
const ApiTokenCreateView = () => {
  ...
  return /* @__PURE__ */ react.createElement(ApiTokenPermissionsContextProvider, { value: providerValue }, /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(dist/* SettingsPageTitle */.SL, { name: "API Tokens" }), /* @__PURE__ */ react.createElement(
    ...
    {
      validationSchema: utils/* schema */.fK,
