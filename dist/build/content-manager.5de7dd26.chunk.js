(self["webpackChunkfilms_demo"] = self["webpackChunkfilms_demo"] || []).push([[994],{
...
var index_es = __webpack_require__(70174);
// EXTERNAL MODULE: ./node_modules/slate-history/dist/index.es.js + 1 modules
var dist_index_es = __webpack_require__(68595);
...
const StyledBaseLink = (0,styled_components_browser_esm/* default */.ZP)((0,BaseLink/* BaseLink */.f))`
  text-decoration: none;
`;
...
const handleBackspaceKeyOnList = (editor, event) => {
  ...
  const isNodeStart = index_es/* Editor */.ML.isStart(editor, editor.selection.anchor, currentListItemPath);
  const isFocusAtTheBeginningOfAChild = editor.selection.focus.offset === 0 && editor.selection.focus.path.at(-1) === 0;
  if (isListEmpty) {
    event.preventDefault();
    replaceListWithEmptyBlock(editor, currentListPath);
  } else if (isNodeStart) {
    index_es/* Transforms */.YR.liftNodes(editor, {
      match: (n) => n.type === "list-item"
    });
    index_es/* Transforms */.YR.setNodes(
      editor,
      { type: "paragraph" },
      {
        hanging: true
    ...
    index_es/* Transforms */.YR.setNodes(editor, { type: "paragraph" });
  }
};
...
const TooltipCustom = (0,styled_components_browser_esm/* default */.ZP)((0,Tooltip/* Tooltip */.u))`
  z-index: 6;
`;
const CustomButton = (0,styled_components_browser_esm/* default */.ZP)((0,Button/* Button */.z))`
  & > span {
    line-height: normal;
  }
`;
const useBlocksStore_Link = react.forwardRef(({ element, children, ...attributes }, forwardedRef) => {
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(
      ...
      /* @__PURE__ */ react.createElement(Icon/* Icon */.J, { width: 3, height: 3, as: Trash/* default */.Z })
    )
  ), /* @__PURE__ */ react.createElement(
    TooltipCustom,
    {
    ...
    /* @__PURE__ */ react.createElement(
      ...
      /* @__PURE__ */ react.createElement(Icon/* Icon */.J, { width: 3, height: 3, as: Pencil/* default */.Z })
    )
  )))));
});
...
const stylesToInherit = (0,styled_components_browser_esm/* css */.iv)`
  font-size: inherit;
  color: inherit;
  line-height: inherit;
`;
...
const ImageDialog = ({ handleClose }) => {
  ...
  const insertImages = (images) => {
    ...
    const [, pathToInsert] = index_es/* Editor */.ML.above(editor, {
      match(node) {
    ...
    index_es/* Transforms */.YR.insertNodes(editor, nodesToInsert, { at: pathToInsert });
  };
...
const BlocksDropdown = ({ disabled }) => {
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(SelectWrapper, null, /* @__PURE__ */ react.createElement(
...
const BlocksToolbar = ({ disabled }) => {
  ...
  return /* @__PURE__ */ react.createElement(react_toolbar_dist/* Root */.fC, { "aria-disabled": disabled, asChild: true }, /* @__PURE__ */ react.createElement(ToolbarWrapper, { gap: 2, padding: 2 }, /* @__PURE__ */ react.createElement(BlocksDropdown, { disabled }), /* @__PURE__ */ react.createElement(Separator, null), /* @__PURE__ */ react.createElement(react_toolbar_dist/* ToggleGroup */.tX, { type: "multiple", asChild: true }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { gap: 1, marginLeft: 1 }, Object.entries(modifiers).map(([name, modifier]) => /* @__PURE__ */ react.createElement(
    ToolbarButton,
    {
      key: name,
      name,
...
const { MUTATE_EDIT_VIEW_LAYOUT } = constants.HOOKS;
...
// EXTERNAL MODULE: ./.cache/admin/src/core/store/hooks.ts
var store_hooks = __webpack_require__(15536);
...
const EntityActionsDataCell = ({
  ...
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { gap: 1, justifyContent: "end", onClick: stopPropagation }, /* @__PURE__ */ react.createElement(
    IconButton/* IconButton */.h,
    {
  ...
  const bulkPublishMutation = (0,react_query_es.useMutation)(
    (data) => post(`/content-manager/collection-types/${contentType.uid}/actions/bulkPublish`, data),
    {
      ...
      onError(error) {
        toggleNotification({
          type: "warning",
          message: (0,formatAPIErrors/* formatAPIErrors */.I)(error)
        });
      }
    }
  );
...
const { INJECT_COLUMN_IN_TABLE } = constants.HOOKS;
...
function ListView({ canCreate, canDelete, canRead, canPublish, layout, slug }) {
  ...
  const { getData, getDataSucceeded } = react.useMemo(
    () => (0,redux.bindActionCreators)(
      { getData: actions_getData, getDataSucceeded: actions_getDataSucceeded },
      dispatch
    ),
    [dispatch]
  );
  const { pagination, isLoading, data } = (0,store_hooks/* useTypedSelector */.ix)(ListView_selectors());
  ...
  const { runHookWaterfall } = (0,dist/* useStrapiApp */.j1)();
  const displayedHeaders = (0,store_hooks/* useTypedSelector */.ix)(selectDisplayedHeaders);
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": isLoading }, /* @__PURE__ */ react.createElement(
    ...
    data.map((rowData, index) => {
      return /* @__PURE__ */ react.createElement(Tr.Tr, { cursor: "pointer", key: rowData.id, onClick: handleRowClick(rowData.id) }, /* @__PURE__ */ react.createElement(Cell.Td, null, /* @__PURE__ */ react.createElement(Body.CheckboxDataCell, { rowId: rowData.id, index })), tableHeaders.map(({ key, name, cellFormatter, ...rest }) => {
      ...
      }), (canDelete || canPublish) && isBulkable && /* @__PURE__ */ react.createElement(Cell.Td, null, /* @__PURE__ */ react.createElement(
...
/* harmony default export */ const pages_ListView = (react.memo(ListView, (isEqual_default())));
...
const { MUTATE_COLLECTION_TYPES_LINKS, MUTATE_SINGLE_TYPES_LINKS } = constants.HOOKS;
